...
#if UNITY_IOS
using PRADOiOSInterface;
#elif UNITY_ANDROID
using PRADOAndroidInterface;
#else
using PRADODummyInterface;
#endif
...
namespace PradoSDK
{
	...
	public class Prado :MonoBehaviour
	{
		...
		//a game object. If Prado game object was added to the scene there is no need to call this function
		...
		{
			pradoin.showInterstitial ( );
			return 0;
		}
		
		public static int showRewarded ()
		{
			pradoin.showRewarded ( );
			return 0;
		}
		...
		//		NO_GAME1_OBJECT	- there is no Prado gameobject 
		public static bool getIsInterstitialLoaded ()
		{
			return pradoin.getIsInterstitialLoaded ( );
			
		}
		
		public static bool getIsRewardedLoaded ()
		{
			return pradoin.getIsRewardedLoaded ( );
		...
		{
			pradoin.setBannerPosition ( (int) position );
			return 0;
		}
